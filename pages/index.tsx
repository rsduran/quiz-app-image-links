...
import {
  Box, Text, Center, VStack, Button, Divider, useColorModeValue, HStack, Grid, GridItem,
  Tabs, TabList, Tab, TabPanels, TabPanel, List, ListItem, ListIcon,
  Accordion, AccordionItem, AccordionButton, AccordionPanel, AccordionIcon, Code, Flex,
    ...
    <LoadingLayout>
      <>
        ...
        <VStack spacing={4} mt={10} align="stretch">
          <Center>
            <VStack spacing={0}>
              <Text fontSize="5xl" fontWeight="bold" color={useColorModeValue('gray.800', 'white')} m={0}>
          ...
          <Center>
            <Text fontSize="2xl" fontWeight="bold" color={useColorModeValue('gray.600', 'gray.200')}> 
              Streamlined quizzes from multiple sources, for effortless bulk answering.
            </Text>
          </Center>
          <Divider my={4} w="50%" alignSelf="center" />
          ...
          <Center>
            ...
            <Button
              ...
              <Link href="/QuizModePage" passHref>
                <Button as="a" variant="outline" borderColor={useColorModeValue('black', 'white')}
                  _hover={{ bg: useColorModeValue('black', 'white'), color: useColorModeValue('white', 'black') }}>
                  Quiz Mode
                </Button>
              </Link>
          ...
          <Center my={2}>
            <Box w="80%">
              <Text fontSize="4xl" fontWeight="bold" color={useColorModeValue('gray.800', 'white')}>
                Instructions: {/* Instructions label */}
              </Text>
              <Accordion allowMultiple>
                <AccordionItem>
                  <AccordionButton>
                  <Box flex='1' textAlign='left' fontWeight="bold">Step 1: Clone and Run</Box>
                    <AccordionIcon />
                  </AccordionButton>
                  <AccordionPanel pb={4}>
                ...
                <AccordionItem>
                  <AccordionButton>
                  <Box flex='1' textAlign='left' fontWeight="bold">Step 2: Install Dependencies</Box>
                    <AccordionIcon />
                  </AccordionButton>
                  <AccordionPanel pb={4}>
                    Next, install the required dependencies using the following command:<br />
                    <Center mt={2}>
                      <pre>
                ...
                <AccordionItem>
                  <AccordionButton>
                  <Box flex='1' textAlign='left' fontWeight="bold">Step 3: Run Athena-CLI and Initiate Local Server</Box>
                    <AccordionIcon />
                  </AccordionButton>
                  <AccordionPanel pb={4}>
                    Open a terminal or command prompt window, navigate to the athena-cli directory, and run the following command to start Athena-CLI:<br />
                    <Center my={2}>
                      <pre>
                        <Code whiteSpace="pre-wrap">python main.py</Code>
                      </pre>
                    </Center>
                    Next, open another terminal or command prompt and initiate a local server using the following command:<br />
                    <Center mt={2}>
                      <pre>
                ...
                <AccordionItem>
                  <AccordionButton>
                  <Box flex='1' textAlign='left' fontWeight="bold">Step 4: Input URLs</Box>
                    <AccordionIcon />
                  </AccordionButton>
                  <AccordionPanel pb={4}>
                    Make sure to input URLs in the following format: [base_url], [start_url], [end_url]. For example:<br />
                    <Center my={2}>
                      <pre>
                        <Code whiteSpace="pre-wrap">https://www.indiabix.com/electronics-and-communication-engineering/networks-analysis-and-synthesis/, 026001, 026010</Code>
                      </pre>
                    </Center>
                    In this one URL, you’ll have a total of 50 questions loaded to the web app, as each URL number in IndiaBIX typically has 5 questions.
                  </AccordionPanel>
                </AccordionItem>
              </Accordion>
            </Box>
          ...
          {/* Footer Bar */}
          <Divider my={4} />
          <Flex as="footer" w="full" py={2} alignItems="center" justifyContent="center"> {/* Centering content */}
