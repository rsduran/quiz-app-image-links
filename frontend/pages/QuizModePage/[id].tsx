...
const QuizModePage = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/getQuestionsByQuizSet/${id}`);
  ...
  const confirmShuffleQuestions = async () => {
    ...
    try {
      ...
      const shuffledResponse = await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/shuffleQuestions/${id}`, { method: 'POST' });
  ...
  const fetchUserSelections = async () => {
    try {
      const response = await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/getUserSelections/${id}`);
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const fetchEyeIconState = async () => {
    const response = await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/getEyeIconState/${id}`);  // Use quiz set ID
    const data = await response.json();
    if (response.ok) {
  ...
  const fetchFavorites = async () => {
    try {
      const response = await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/getFavorites/${id}`);
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const handleToggleFavorites = (questionId: number) => {
    fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/toggleFavorite`, {
      method: 'POST',
  ...
  const handleOptionSelect = async (optionIndex: number | null) => {
    ...
    await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/updateUserSelection`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
const updateScore = async (questionId: number, scoreChange: number) => {
  await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/updateScore`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const updateQuizSetStatus = async (status: string) => {
    try {
      await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/updateQuizSetStatus/${id}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const updateScoreInDatabase = (score: number) => {
    ...
    fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/updateQuizSetScore/${id}`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const handleReset = async () => {
    ...
    try {
      const response = await fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/resetQuestions/${id}`, {
        method: 'POST'
      });
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const toggleFlipCardVisibility = () => {
    ...
    fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/updateEyeIconState/${id}`, {  // Use quiz set ID
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
