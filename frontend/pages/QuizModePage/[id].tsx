...
const QuizModePage = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/getQuestionsByQuizSet/${id}`);
  ...
  const confirmShuffleQuestions = async () => {
    ...
    try {
      ...
      const shuffledResponse = await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/shuffleQuestions/${id}`, { method: 'POST' });
  ...
  const fetchUserSelections = async () => {
    try {
      const response = await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/getUserSelections/${id}`);
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const fetchEyeIconState = async () => {
    const response = await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/getEyeIconState/${id}`);  // Use quiz set ID
    const data = await response.json();
    if (response.ok) {
  ...
  const fetchFavorites = async () => {
    try {
      const response = await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/getFavorites/${id}`);
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const handleToggleFavorites = (questionId: number) => {
    fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/toggleFavorite`, {
      method: 'POST',
  ...
  const handleOptionSelect = async (optionIndex: number | null) => {
    ...
    await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/updateUserSelection`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
const updateScore = async (questionId: number, scoreChange: number) => {
  await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/updateScore`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const updateQuizSetStatus = async (status: string) => {
    try {
      await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/updateQuizSetStatus/${id}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const updateScoreInDatabase = (score: number) => {
    ...
    fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/updateQuizSetScore/${id}`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const handleReset = async () => {
    ...
    try {
      const response = await fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/resetQuestions/${id}`, {
        method: 'POST'
      });
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const toggleFlipCardVisibility = () => {
    ...
    fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/updateEyeIconState/${id}`, {  // Use quiz set ID
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
        ...
        <Flex justifyContent="space-between" mb={4}>
          ...
          <Flex flex="1" justify="center" align="center">
            ...
            <Input
              ...
              w="75px"
              mr={2}
              fontSize="15px" // Add the fontSize property here
            />
            <Text mx={2} fontSize="15px">/ {filteredQuestions.length}</Text>
          ...
          <Flex flex="1" align="center" gap={2}>
            ...
            <Tooltip label="Shuffle" aria-label="Shuffle Tooltip">
              <IconButton aria-label="Shuffle" icon={<ShuffleIcon style={{ width: '20px', height: '20px' }} />} onClick={onConfirmationModalOpen} bg='transparent' _hover={{ bg: iconHoverBg }} />
            </Tooltip>
            <Tooltip label="Search" aria-label="Search Tooltip">
              <IconButton aria-label="Search" icon={<MagnifyingGlassIcon style={{ width: '23px', height: '23px' }} />} onClick={onSearchModalOpen} bg='transparent' _hover={{ bg: iconHoverBg }} />
            </Tooltip>
