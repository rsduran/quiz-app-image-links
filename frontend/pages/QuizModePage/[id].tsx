...
const QuizModePage = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/getQuestionsByQuizSet/${id}`);
  ...
  const confirmShuffleQuestions = async () => {
    ...
    try {
      ...
      const shuffledResponse = await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/shuffleQuestions/${id}`, { method: 'POST' });
  ...
  const fetchUserSelections = async () => {
    try {
      const response = await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/getUserSelections/${id}`);
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const fetchEyeIconState = async () => {
    const response = await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/getEyeIconState/${id}`);  // Use quiz set ID
    const data = await response.json();
    if (response.ok) {
  ...
  const fetchFavorites = async () => {
    try {
      const response = await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/getFavorites/${id}`);
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const handleToggleFavorites = (questionId: number) => {
    fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/toggleFavorite`, {
      method: 'POST',
  ...
  const handleOptionSelect = async (optionIndex: number | null) => {
    ...
    await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/updateUserSelection`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
const updateScore = async (questionId: number, scoreChange: number) => {
  await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/updateScore`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const updateQuizSetStatus = async (status: string) => {
    try {
      await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/updateQuizSetStatus/${id}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const updateScoreInDatabase = (score: number) => {
    ...
    fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/updateQuizSetScore/${id}`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const handleReset = async () => {
    ...
    try {
      const response = await fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/resetQuestions/${id}`, {
        method: 'POST'
      });
      if (!response.ok) throw new Error('Network response was not ok');
  ...
  const toggleFlipCardVisibility = () => {
    ...
    fetch(`http://a9184e9e7d5f94758bf1670e8fb3fa88-841219625.ap-southeast-2.elb.amazonaws.com/api/updateEyeIconState/${id}`, {  // Use quiz set ID
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
