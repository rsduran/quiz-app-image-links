...
const CalendarEditor = () => {
  ...
  const fetchEditorContent = () => {
    fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/getEditorContent`)
  ...
  const handleEditorChange = (content: string) => {
    ...
    fetch(`http://k8s-threetie-backends-53ff77a1f2-63fc387682774c76.elb.ap-southeast-2.amazonaws.com/api/saveEditorContent`, {
      method: 'POST',
