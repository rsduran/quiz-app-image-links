...
const CalendarEditor = () => {
  ...
  const fetchEditorContent = () => {
    fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/getEditorContent`)
  ...
  const handleEditorChange = (content: string) => {
    ...
    fetch(`http://k8s-threetie-backends-c64f4e05fa-65b5de78c7586965.elb.ap-southeast-2.amazonaws.com/api/saveEditorContent`, {
      method: 'POST',
